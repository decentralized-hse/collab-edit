...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            version("kotlinExtensions", "1.0.1-pre.144-kotlin-1.4.21")
            alias("kotlin-extensions").to("org.jetbrains", "kotlin-extensions").versionRef("kotlinExtensions")

            version("kotlinReact", "17.0.1-pre.144-kotlin-1.4.21")
            ...
            version("kotlinStyled", "5.2.1-pre.148-kotlin-1.4.21")
